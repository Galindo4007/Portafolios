...
# Hubieron varios problemas a la hora de analizar los datos por lo que solo se puede usar esta cantidad de datos, ya que
# si se agregan más datos los resultados van a dar NaN por lo que solo se pueden usar estos datos
df = df.head(675)
print(df)
